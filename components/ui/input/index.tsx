...
const inputStyle = tva({
  base: 'flex-row content-center items-center overflow-hidden rounded-lg border border-beige px-1 py-3 outline-none data-[focus=true]:border-white data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300',
});
